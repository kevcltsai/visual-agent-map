...
export interface TaskContext { title: string; summary: string; rules: string; detail: string; task: string; ancestors: string; workingFindings?: string; sourceContext?: string; mode?: AiTaskKind; researchMode?: ResearchMode; researchDepth?: ResearchDepth; visualMode?: VisualMode }
